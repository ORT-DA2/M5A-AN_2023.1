...
import { ADD_MOVIE_URL, getUrl, ROUTE_CONFIG_ID_PARAM, MOVIE_FORM_URL } from '../../utils/routes';
...
export class MovieListComponent implements OnInit {
  ...
  public navigateToEditMovie(movie: Movie): void {
    this._router.navigateByUrl(`/${getUrl(MOVIE_FORM_URL, ROUTE_CONFIG_ID_PARAM, movie.id)}`);
  }
